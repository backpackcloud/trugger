...
import org.atatec.trugger.util.MultiResourceBundle;
...
public class MultiResourceBundleTest {
  ...
  public void initialize() {
    defaultBundle = ResourceBundle.getBundle("org.atatec.trugger.test.general.default", new Locale("pt"));
    firstBundle = ResourceBundle.getBundle("org.atatec.trugger.test.general.first-level", Locale.ENGLISH);
    secondBundle = ResourceBundle.getBundle("org.atatec.trugger.test.general.second-level", Locale.ITALIAN);
