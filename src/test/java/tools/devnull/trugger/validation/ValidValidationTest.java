...
import tools.devnull.trugger.validation.validator.NotEmpty;
...
public class ValidValidationTest extends BaseValidatorTest<Valid> {
  ...
  public void test() {
    ...
    assertNull(result.invalidElement("projects.1.author").value());
    assertEquals("", result.invalidElement("projects.1.name").value());
