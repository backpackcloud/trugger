...
import tools.devnull.trugger.TruggerTest;
...
import static tools.devnull.trugger.reflection.ClassPredicates.declaring;
...
public class ClassScanTest {
  ...
  private String filePackageName = "tools.devnull.trugger.scan.classes";
  ...
  public void testFindInFile() {
    scanTest("tools.devnull.trugger");
  }
  ...
  public void testScanLevelInFile() {
    scanLevelTest("tools.devnull.trugger");
  }
  ...
  public void testScanPackageInFile() {
    ...
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyClass.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyAnnotation.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyEnum.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyInterface.class));
  ...
  public void testScanSubPackageInFile() {
    ...
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyClass.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.pack.MyClass2.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyAnnotation.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.pack.MyAnnotation2.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyEnum.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.pack.MyEnum2.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.MyInterface.class));
    assertTrue(list.contains(tools.devnull.trugger.scan.classes.pack.MyInterface2.class));
