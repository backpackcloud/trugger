...
/**
 * An exception handler that encapsulates causes of exceptions.
 *
 * @author Marcelo Guimarães
 * @since 4.0
 */
public class CauseEncapsulatorExceptionHandler implements ExceptionHandler {

  private final Class<? extends RuntimeException> encapsulate;

  public CauseEncapsulatorExceptionHandler(Class<? extends RuntimeException> encapsulate) {
